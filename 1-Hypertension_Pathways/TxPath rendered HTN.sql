...
IF OBJECT_ID('#HTN_indexcohort', 'U') IS NOT NULL
	DROP TABLE #HTN_indexcohort;

IF OBJECT_ID('#HTN_e0', 'U') IS NOT NULL
	DROP TABLE #HTN_e0;

IF OBJECT_ID('#HTN_t0', 'U') IS NOT NULL
	DROP TABLE #HTN_t0;

IF OBJECT_ID('#HTN_t1', 'U') IS NOT NULL
	DROP TABLE #HTN_t1;

IF OBJECT_ID('#HTN_t2', 'U') IS NOT NULL
	DROP TABLE #HTN_t2;

IF OBJECT_ID('#HTN_t3', 'U') IS NOT NULL
	DROP TABLE #HTN_t3;

IF OBJECT_ID('#HTN_t4', 'U') IS NOT NULL
	DROP TABLE #HTN_t4;

IF OBJECT_ID('#HTN_t5', 'U') IS NOT NULL
	DROP TABLE #HTN_t5;

IF OBJECT_ID('#HTN_t6', 'U') IS NOT NULL
	DROP TABLE #HTN_t6;

IF OBJECT_ID('#HTN_t7', 'U') IS NOT NULL
	DROP TABLE #HTN_t7;

IF OBJECT_ID('#HTN_t8', 'U') IS NOT NULL
	DROP TABLE #HTN_t8;

IF OBJECT_ID('#HTN_t9', 'U') IS NOT NULL
	DROP TABLE #HTN_t9;

IF OBJECT_ID('#HTN_matchcohort', 'U') IS NOT NULL
	DROP TABLE #HTN_matchcohort;

IF OBJECT_ID('#HTN_drug_seq', 'U') IS NOT NULL
	DROP TABLE #HTN_drug_seq;

IF OBJECT_ID('#HTN_drug_seq_summary', 'U') IS NOT NULL
	DROP TABLE #HTN_drug_seq_summary;

IF OBJECT_ID('HTN_person_count', 'U') IS NOT NULL
	DROP TABLE HTN_person_count;

IF OBJECT_ID('HTN_person_count_year', 'U') IS NOT NULL
	DROP TABLE HTN_person_count_year;

IF OBJECT_ID('HTN_seq_count', 'U') IS NOT NULL
	DROP TABLE HTN_seq_count;	

IF OBJECT_ID('HTN_seq_count_year', 'U') IS NOT NULL
	DROP TABLE HTN_seq_count_year;
	
create table #HTN_IndexCohort
(
...
(
	...
	JOIN cdm_schema.dbo.CONCEPT_ANCESTOR ca on co.CONDITION_CONCEPT_ID = ca.DESCENDANT_CONCEPT_ID and ca.ANCESTOR_CONCEPT_ID in (444094)
...
(
	...
	JOIN cdm_schema.dbo.CONCEPT_ANCESTOR ca on de.DRUG_CONCEPT_ID = ca.DESCENDANT_CONCEPT_ID and ca.ANCESTOR_CONCEPT_ID in (21600381,21601461,21601560,21601664,21601744,21601782)
...
(
	...
	JOIN cdm_schema.dbo.CONCEPT_ANCESTOR ca on ce.CONDITION_CONCEPT_ID = ca.DESCENDANT_CONCEPT_ID and ca.ANCESTOR_CONCEPT_ID in (316866)
...
where drug_concept_id in (select descendant_concept_id from cdm_schema.dbo.concept_ancestor where ancestor_concept_id in (21600381,21601461,21601560,21601664,21601744,21601782))
...
create table #HTN_drug_seq_summary
(
	index_year int,
	d1_concept_id int,
	d2_concept_id int,
...
IF OBJECT_ID('TxPath_source_name_HTN_person_count', 'U') IS NOT NULL
	DROP TABLE TxPath_source_name_HTN_person_count;

create table results_schema.dbo.TxPath_source_name_HTN_person_count
(
	num_persons int
);


insert into results_schema.dbo.TxPath_source_name_HTN_person_count (num_persons)
select num_persons
from
(
...
IF OBJECT_ID('TxPath_source_name_HTN_person_count_year', 'U') IS NOT NULL
	DROP TABLE TxPath_source_name_HTN_person_count_year;

create table results_schema.dbo.TxPath_source_name_HTN_person_count_year
(
	index_year int,
	num_persons int
);

insert into results_schema.dbo.TxPath_source_name_HTN_person_count_year (index_year, num_persons)
...
IF OBJECT_ID('TxPath_source_name_HTN_seq_count', 'U') IS NOT NULL
	DROP TABLE TxPath_source_name_HTN_seq_count;

create table results_schema.dbo.TxPath_source_name_HTN_seq_count
(
	d1_concept_id int, 
	d2_concept_id int, 
	d3_concept_id int, 
...
insert into results_schema.dbo.TxPath_source_name_HTN_seq_count (d1_concept_id, d2_concept_id, d3_concept_id, d4_concept_id, d5_concept_id, d6_concept_id, d7_concept_id, d8_concept_id, d9_concept_id, d10_concept_id, d11_concept_id, d12_concept_id, d13_concept_id, d14_concept_id, d15_concept_id, d16_concept_id, d17_concept_id, d18_concept_id, d19_concept_id, d20_concept_id, d1_concept_name, d2_concept_name, d3_concept_name, d4_concept_name, d5_concept_name, d6_concept_name, d7_concept_name, d8_concept_name, d9_concept_name, d10_concept_name, d11_concept_name, d12_concept_name, d13_concept_name, d14_concept_name, d15_concept_name, d16_concept_name, d17_concept_name, d18_concept_name, d19_concept_name, d20_concept_name, num_persons)
select *
from
(
...
IF OBJECT_ID('TxPath_source_name_HTN_seq_count_year', 'U') IS NOT NULL
	DROP TABLE TxPath_source_name_HTN_seq_count_year;


create table results_schema.dbo.TxPath_source_name_HTN_seq_count_year
(
	index_year int,
	d1_concept_id int, 
	d2_concept_id int, 
