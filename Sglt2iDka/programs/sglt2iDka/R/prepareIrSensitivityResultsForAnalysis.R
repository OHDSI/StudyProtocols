#' @export
prepareIrSensitivityResultsForAnalysis <- function(outputFolder,
                                                   databaseName,
                                                   maxCores) {
  packageName <- "sglt2iDka"
  cmIrSensitivityOutputFolder <- file.path(outputFolder, "cmIrSensitivityOutput")
  resultsFolder <- file.path(outputFolder, "results")
  if (!file.exists(resultsFolder))
    dir.create(resultsFolder)
  irSensitivityDataFolder <- file.path(resultsFolder, "irSensitivityData")
  if (!file.exists(irSensitivityDataFolder))
    dir.create(irSensitivityDataFolder)

  # TCOs of interest
  tcosOfInterest <- read.csv(system.file("settings", "tcoIrSensitivityVariants.csv", package = packageName), stringsAsFactors = FALSE)
  ...
  reference <- readRDS(file.path(cmIrSensitivityOutputFolder, "outcomeModelReference.rds"))
  ...
  cmAnalysisList <- CohortMethod::loadCmAnalysisList(system.file("settings", "cmIrSensitivityAnalysisList.json", package = packageName))
  ...
  runTc <- function(chunk,
    ...
    for (analysisId in unique(reference$analysisId)) { # only 1 analysis
      ...
      for (outcomeId in outcomeIds) {
        ...
        covariates <- covariates[covariates$covariateId %in% c(8507001, 1998, 2998, 200999, 201999, # intentionally drop 8532001 as redundant
        ...
        names(covariates)[names(covariates) == "covariateValue.8507001"] <- "Male"
        names(covariates)[names(covariates) == "covariateValue.1998"] <- "PriorInsulin"
        names(covariates)[names(covariates) == "covariateValue.2998"] <- "PriorAha"
        names(covariates)[names(covariates) == "covariateValue.200999"] <- "PriorDkaIpEr"
        names(covariates)[names(covariates) == "covariateValue.201999"] <- "PriorDkaIp"
        if (is.null(covariates$covariateValue.2003)) covariates$Age10_14 <- 0 else covariates$Age10_14[covariates$covariateValue.2003 == 1] <- 1
        if (is.null(covariates$covariateValue.3003)) covariates$Age15_19 <- 0 else covariates$Age15_19[covariates$covariateValue.3003 == 1] <- 1
        if (is.null(covariates$covariateValue.4003)) covariates$Age20_24 <- 0 else covariates$Age20_24[covariates$covariateValue.4003 == 1] <- 1
        if (is.null(covariates$covariateValue.5003)) covariates$Age25_29 <- 0 else covariates$Age25_29[covariates$covariateValue.5003 == 1] <- 1
        if (is.null(covariates$covariateValue.6003)) covariates$Age30_34 <- 0 else covariates$Age30_34[covariates$covariateValue.6003 == 1] <- 1
        if (is.null(covariates$covariateValue.7003)) covariates$Age35_39 <- 0 else covariates$Age35_39[covariates$covariateValue.7003 == 1] <- 1
        if (is.null(covariates$covariateValue.8003)) covariates$Age40_44 <- 0 else covariates$Age40_44[covariates$covariateValue.8003 == 1] <- 1
        if (is.null(covariates$covariateValue.9003)) covariates$Age45_49 <- 0 else covariates$Age45_49[covariates$covariateValue.9003 == 1] <- 1
        if (is.null(covariates$covariateValue.10003)) covariates$Age50_54 <- 0 else covariates$Age50_54[covariates$covariateValue.10003 == 1] <- 1
        if (is.null(covariates$covariateValue.11003)) covariates$Age55_59 <- 0 else covariates$Age55_59[covariates$covariateValue.11003 == 1] <- 1
        if (is.null(covariates$covariateValue.12003)) covariates$Age60_64 <- 0 else covariates$Age60_64[covariates$covariateValue.12003 == 1] <- 1
        if (is.null(covariates$covariateValue.13003)) covariates$Age65_69 <- 0 else covariates$Age65_69[covariates$covariateValue.13003 == 1] <- 1
        if (is.null(covariates$covariateValue.14003)) covariates$Age70_74 <- 0 else covariates$Age70_74[covariates$covariateValue.14003 == 1] <- 1
        if (is.null(covariates$covariateValue.15003)) covariates$Age75_79 <- 0 else covariates$Age75_79[covariates$covariateValue.15003 == 1] <- 1
        if (is.null(covariates$covariateValue.16003)) covariates$Age80_84 <- 0 else covariates$Age80_84[covariates$covariateValue.16003 == 1] <- 1
        if (is.null(covariates$covariateValue.17003)) covariates$Age85_89 <- 0 else covariates$Age85_89[covariates$covariateValue.17003 == 1] <- 1
        if (is.null(covariates$covariateValue.18003)) covariates$Age90_94 <- 0 else covariates$Age90_94[covariates$covariateValue.18003 == 1] <- 1
        if (is.null(covariates$covariateValue.19003)) covariates$Age95_99 <- 0 else covariates$Age95_99[covariates$covariateValue.19003 == 1] <- 1
        if (is.null(covariates$covariateValue.20003)) covariates$Age100_104 <- 0 else covariates$Age100_104[covariates$covariateValue.20003 == 1] <- 1
        if (is.null(covariates$covariateValue.21003)) covariates$Age105_109 <- 0 else covariates$Age105_109[covariates$covariateValue.21003 == 1] <- 1
        covariates$Age10_19[covariates$Age10_14 == 1 | covariates$Age15_19 == 1] <- 1
        covariates$Age20_29[covariates$Age20_24 == 1 | covariates$Age25_29 == 1] <- 1
        covariates$Age30_39[covariates$Age30_34 == 1 | covariates$Age35_39 == 1] <- 1
        covariates$Age40_49[covariates$Age40_44 == 1 | covariates$Age45_49 == 1] <- 1
        covariates$Age50_59[covariates$Age50_54 == 1 | covariates$Age55_59 == 1] <- 1
        covariates$Age60_69[covariates$Age60_64 == 1 | covariates$Age65_69 == 1] <- 1
        covariates$Age70_79[covariates$Age70_74 == 1 | covariates$Age75_79 == 1] <- 1
        covariates$Age80_89[covariates$Age80_84 == 1 | covariates$Age85_89 == 1] <- 1
        covariates$Age90_99[covariates$Age90_94 == 1 | covariates$Age95_99 == 1] <- 1
        covariates$Age100_109[covariates$Age100_104 == 1 | covariates$Age105_109 == 1] <- 1

        studyPop <- readRDS(refRow$studyPopFile)
        studyPop <- merge(studyPop, covariates, by = "rowId", all.x = TRUE)
  ...
  fileName <- file.path(irSensitivityDataFolder, paste0("irSensitivityData_", databaseName,".rds"))
