...
IF OBJECT_ID('@studyName_@sourceName_person_count', 'U') IS NOT NULL
	DROP TABLE @studyName_@sourceName_person_count;

create table @resultsSchema.dbo.@studyName_@sourceName_person_count
(
	num_persons int
);


insert into @resultsSchema.dbo.@studyName_@sourceName_person_count (num_persons)
select num_persons
from
(
...
IF OBJECT_ID('@studyName_@sourceName_seq_count', 'U') IS NOT NULL
	DROP TABLE @studyName_@sourceName_seq_count;

create table @resultsSchema.dbo.@studyName_@sourceName_seq_count
(
	d1_concept_id int, 
	d2_concept_id int, 
	d3_concept_id int, 
...
insert into @resultsSchema.dbo.@studyName_@sourceName_seq_count (d1_concept_id, d2_concept_id, d3_concept_id, d4_concept_id, d5_concept_id, d6_concept_id, d7_concept_id, d8_concept_id, d9_concept_id, d10_concept_id, d11_concept_id, d12_concept_id, d13_concept_id, d14_concept_id, d15_concept_id, d16_concept_id, d17_concept_id, d18_concept_id, d19_concept_id, d20_concept_id, d1_concept_name, d2_concept_name, d3_concept_name, d4_concept_name, d5_concept_name, d6_concept_name, d7_concept_name, d8_concept_name, d9_concept_name, d10_concept_name, d11_concept_name, d12_concept_name, d13_concept_name, d14_concept_name, d15_concept_name, d16_concept_name, d17_concept_name, d18_concept_name, d19_concept_name, d20_concept_name, num_persons)
select *
from
(
