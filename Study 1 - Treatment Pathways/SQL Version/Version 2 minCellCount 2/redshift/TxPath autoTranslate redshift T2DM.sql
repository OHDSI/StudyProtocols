...
DROP TABLE IF EXISTS  T2DM_e0;

DROP TABLE IF EXISTS  T2DM_t0;

DROP TABLE IF EXISTS  T2DM_t1;

DROP TABLE IF EXISTS  T2DM_t2;

DROP TABLE IF EXISTS  T2DM_t3;

DROP TABLE IF EXISTS  T2DM_t4;

DROP TABLE IF EXISTS  T2DM_t5;

DROP TABLE IF EXISTS  T2DM_t6;

DROP TABLE IF EXISTS  T2DM_t7;

DROP TABLE IF EXISTS  T2DM_t8;

DROP TABLE IF EXISTS  T2DM_t9;

DROP TABLE IF EXISTS  T2DM_matchcohort;

DROP TABLE IF EXISTS  T2DM_drug_seq;

DROP TABLE IF EXISTS  T2DM_drug_seq_summary;

DROP TABLE IF EXISTS  T2DM_person_count;

DROP TABLE IF EXISTS  T2DM_person_count_year;

DROP TABLE IF EXISTS  T2DM_seq_count;	

DROP TABLE IF EXISTS  T2DM_seq_count_year;
...
CREATE TEMP TABLE T2DM_MatchCohort
 (
	PERSON_ID bigint not null primary key,
	INDEX_DATE date not null,
	COHORT_END_DATE date not null,
...
CREATE TEMP TABLE T2DM_drug_seq
 (
	person_id bigint,
	index_year int,
	drug_concept_id int,
...
CREATE TEMP TABLE T2DM_drug_seq_summary
 (
	index_year int,
	d1_concept_id int,
	d2_concept_id int,
...
*****/
  ...
  CREATE TEMP TABLE T2DM_drug_seq_summary_temp
   (
    index_year int,
  	d1_concept_id int,
  	d2_concept_id int,
  ...
  insert into T2DM_drug_seq_summary_temp (index_year, d1_concept_id, d2_concept_id, d3_concept_id, d4_concept_id, d5_concept_id, d6_concept_id, d7_concept_id, d8_concept_id, d9_concept_id, d10_concept_id, d11_concept_id, d12_concept_id, d13_concept_id, d14_concept_id, d15_concept_id, d16_concept_id, d17_concept_id, d18_concept_id, d19_concept_id, d20_concept_id, d1_concept_name, d2_concept_name, d3_concept_name, d4_concept_name, d5_concept_name, d6_concept_name, d7_concept_name, d8_concept_name, d9_concept_name, d10_concept_name, d11_concept_name, d12_concept_name, d13_concept_name, d14_concept_name, d15_concept_name, d16_concept_name, d17_concept_name, d18_concept_name, d19_concept_name, d20_concept_name, num_persons)
  select index_year, d1_concept_id, d2_concept_id, d3_concept_id, d4_concept_id, d5_concept_id, d6_concept_id, d7_concept_id, d8_concept_id, d9_concept_id, d10_concept_id, d11_concept_id, d12_concept_id, d13_concept_id, d14_concept_id, d15_concept_id, d16_concept_id, d17_concept_id, d18_concept_id, d19_concept_id, d20_concept_id, d1_concept_name, d2_concept_name, d3_concept_name, d4_concept_name, d5_concept_name, d6_concept_name, d7_concept_name, d8_concept_name, d9_concept_name, d10_concept_name, d11_concept_name, d12_concept_name, d13_concept_name, d14_concept_name, d15_concept_name, d16_concept_name, d17_concept_name, d18_concept_name, d19_concept_name, d20_concept_name, num_persons
  from
  T2DM_drug_seq_summary;
  
  delete from T2DM_drug_seq_summary;
  																...
  																(
  																	...
  																	from
  																		...
  																		select index_year,  
  																			...
  																			case when d20_concept_id > 0 and num_persons < 2 then 'Other' when d19_concept_id = -1 then null else d20_concept_name end as d20_concept_name,
  																			sum(num_persons) as num_persons
  																		from T2DM_drug_seq_summary_temp
  																		group by index_year,  
...
TRUNCATE TABLE T2DM_drug_seq_summary_temp;
DROP TABLE T2DM_drug_seq_summary_temp;
...
DROP TABLE IF EXISTS  T2DM_source_name_population_summary;

create table resuts_schema.T2DM_source_name_population_summary
(
...
insert into resuts_schema.T2DM_source_name_population_summary (count_type, num_persons)
CREATE TABLE  resuts_schema.T2DM_source_name_population_summary (count_type, num_persons)
CREATE TABLE  resuts_schema.T2DM_source_name_population_summary (count_type, num_persons)
...
DROP TABLE IF EXISTS  T2DM_source_name_person_count_year;

create table resuts_schema.T2DM_source_name_person_count_year
(
	index_year int,
	num_persons int
);

insert into resuts_schema.T2DM_source_name_person_count_year (index_year, num_persons)
...
DROP TABLE IF EXISTS  T2DM_source_name_seq_count_year;


create table resuts_schema.T2DM_source_name_seq_count_year
(
	index_year int,
	d1_concept_id int, 
	d2_concept_id int, 
