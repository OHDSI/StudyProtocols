...
*****/
  ...
  create table #Depression_drug_seq_summary_temp
  (
    index_year int,
  	d1_concept_id int,
  	d2_concept_id int,
...
IF OBJECT_ID('Depression_source_name_population_summary', 'U') IS NOT NULL
  DROP TABLE Depression_source_name_population_summary;

create table resuts_schema.dbo.Depression_source_name_population_summary
(
...
insert into resuts_schema.dbo.Depression_source_name_population_summary (count_type, num_persons)
...
create table resuts_schema.dbo.Depression_source_name_person_count_year
(
	index_year int,
	num_persons int
);

insert into resuts_schema.dbo.Depression_source_name_person_count_year (index_year, num_persons)
...
create table resuts_schema.dbo.Depression_source_name_seq_count_year
(
	index_year int,
	d1_concept_id int, 
	d2_concept_id int, 
