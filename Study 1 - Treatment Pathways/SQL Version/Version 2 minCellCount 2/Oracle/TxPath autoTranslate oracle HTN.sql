...
*****/
  ...
  CREATE GLOBAL TEMPORARY TABLE HTN_drug_seq_summary_temp
   (
    index_year int,
  	d1_concept_id int,
  	d2_concept_id int,
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE  HTN_source_name_population_summary';
  EXECUTE IMMEDIATE 'DROP TABLE  HTN_source_name_population_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
create table resuts_schema.HTN_source_name_population_summary
(
...
insert into resuts_schema.HTN_source_name_population_summary (count_type, num_persons)
CREATE TABLE  resuts_schema.HTN_source_name_population_summary (count_type, num_persons)
CREATE TABLE  resuts_schema.HTN_source_name_population_summary (count_type, num_persons)
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE  HTN_source_name_person_count_year';
  EXECUTE IMMEDIATE 'DROP TABLE  HTN_source_name_person_count_year';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
create table resuts_schema.HTN_source_name_person_count_year
(
	index_year int,
	num_persons int
);

insert into resuts_schema.HTN_source_name_person_count_year (index_year, num_persons)
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE  HTN_source_name_seq_count_year';
  EXECUTE IMMEDIATE 'DROP TABLE  HTN_source_name_seq_count_year';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
create table resuts_schema.HTN_source_name_seq_count_year
(
	index_year int,
	d1_concept_id int, 
	d2_concept_id int, 
