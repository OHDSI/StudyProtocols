...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE  HTN_source_name_person_count';
  EXECUTE IMMEDIATE 'DROP TABLE  HTN_source_name_person_count';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE  HTN_source_name_seq_count';
  EXECUTE IMMEDIATE 'DROP TABLE  HTN_source_name_seq_count';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
