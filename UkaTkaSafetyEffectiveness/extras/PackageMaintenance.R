...
OhdsiRTools::checkUsagePackage("UkaTkaSafetyFull")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/UkaTkaSafetyFull.pdf")
shell("R CMD Rd2pdf ./ --output=extras/UkaTkaSafetyFull.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("UkaTkaSafetyFull")
