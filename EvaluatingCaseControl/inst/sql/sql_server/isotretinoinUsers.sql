...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40166035,1580747,19122137)and invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (984232)and invalid_reason is null
