...
SELECT CONCEPT.concept_name AS substance_name, COUNT(DISTINCT(exposed_person_id)) AS distinct_person_count
FROM filtered_list_of_exposed_persons_and_substances, CONCEPT
