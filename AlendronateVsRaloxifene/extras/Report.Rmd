...
saveTable <- function(obj, caption = NULL, number = NULL, name) {
  first <- name
  ...
  cat(paste0("\\begin{table}[ht]\\centering", obj))
  ...
  cmd <- paste("dvipng -T tight -D 400", shQuote(paste(first,".dvi",sep="")))
...
```{r echo=FALSE, results="asis"}
printOutcomeTable(analysisId = 1, folders, paste0(label1, " ", label2), "HipFracture", "", singleTable = TRUE)
```
