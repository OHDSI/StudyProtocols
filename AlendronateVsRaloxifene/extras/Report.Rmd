...
printPValueTable <- function(analysisId,
  ...
  crude <- results[,c("db", "null_mean", "null_sd", "space1", "logRr", "seLogRr", "p", "space2",
  ...
  addtorow$command <- c("& \\multicolumn{2}{c}{Empirical Null Dist.} & & \\multicolumn{3}{c}{Original Estimate} & & \\multicolumn{3}{c}{Calibrated P-value} \\\\\n",
                        "\\cline{2-3} \\cline{5-7} \\cline{9-11} \\\\[-1em]\n",
...
printPValueTable(analysisId = 1, folders, paste0(label1, " ", label2), cohortOrder1, prettyCohortNames1, singleTable = FALSE)
```
