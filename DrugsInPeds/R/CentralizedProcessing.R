...
.centralizedProcessing <- function(){
    ...
    #dbs <- data.frame(name = c("AUSOM","CDARS","JMDC"), inpatient = c(TRUE, TRUE, TRUE), ambulatory = c(FALSE, FALSE, TRUE), stringsAsFactors = FALSE)
    dbs <- data.frame(name = c("JMDC"), inpatient = c(TRUE), ambulatory = c(TRUE), stringsAsFactors = FALSE)
