...
output: 
    word_document:
        ...
        toc: yes
params: 
    exportFolder: S:/temp/AlendronateVsRaloxifeneMdcd/export
---
...
```{r, echo = FALSE, fig.width = 5, fig.height= 4, fig.cap = "Attrition diagram when using stratification on propensity scores. Original cohorts are the treatment and comparator cohorts as defined in CIRCE."}
